# ══════════════════════════════════════════════════════════════════════════════
# Step 1bc — DataLoaders + Model + Train + Evaluate
# ══════════════════════════════════════════════════════════════════════════════
# All-in-one: loaders, 80D→80D MLP, train, evaluate.
...
class MetricPredictor(nn.Module):
    """80D degraded → 80D clean metrics."""
...
print(f"\n{'='*60}")
print(f"STEP 1bc EVALUATION — 80D Metric Literacy (normalized training)")
print(f"{'='*60}")
...
tier1_mae = np.mean(per_dim_mae[67:])
print(f"\nTier 0 (67D) MAE: {tier0_mae:.4f}")
print(f"Tier 1 (13D) MAE: {tier1_mae:.4f}")

print(f"\n{'='*60}")
if tier1_mae < 5.0:
    print("✅ PASSED — model learns all 80D metrics")
elif tier1_mae < 20.0:
