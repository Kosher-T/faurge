# ══════════════════════════════════════════════════════════════════════════════
# Step 1bc — Metric Literacy: Setup
# ══════════════════════════════════════════════════════════════════════════════
# Teach the model what 80D metrics mean.
# Input:  degraded metrics (80D)
# Output: clean metrics (80D)
# No plugins. Just metric-to-metric reconstruction.
...
print(f"\nStep 1bc: Metric Literacy (80D)")
print(f"Input:  80D (degraded metrics)")
print(f"Output: 80D (clean metrics)")
